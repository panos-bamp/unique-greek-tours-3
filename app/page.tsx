    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Link href="/tours/nafplio/nafplio-mycenae-epidavros/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/mycenae-tour-hero-1.jpg" alt="Mycenae & Epidaurus" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €280</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Nafplio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Mycenae & Epidaurus</h3>
                <p className="text-sm text-gray-600 mb-3">8 hours</p>
                <span className="text-blue-600 font-semibold text-sm">View Tour</span>
              </div>
            </Link>
            ...
            <Link href="/tours/nafplio/nafplio-ancient-olympia-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/olympia-tour-hero-1.jpg" alt="Ancient Olympia Day Trip" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €380</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Nafplio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Ancient Olympia Day Trip</h3>
            ...
            <Link href="/tours/nafplio/nafplio-winetasting-tour-nemea/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/wine-tour-hero-1.jpg" alt="Nemea Wine Tasting" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €220</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Nafplio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Nemea Wine Tasting</h3>
            ...
            <Link href="/tours/nafplio/nafplio-sparta-mystras-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/sparta-tour-hero-1.jpg" alt="Sparta & Mystras Tour" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €350</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Nafplio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Sparta & Mystras Tour</h3>
            ...
            <Link href="/tours/nafplio/nafplio-monemvasia-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/monemvasia-tour-hero-1.jpg" alt="Monemvasia Castle Tour" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €360</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Nafplio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Monemvasia Castle Tour</h3>
                <p className="text-sm text-gray-600 mb-3">10 hours</p>
                <span className="text-blue-600 font-semibold text-sm">View Tour</span>
              </div>
            </Link>
            ...
            <Link href="/tours/gythio/gythio-diros-caves-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/monemvasia-tour-hero-2.jpg" alt="Diros Caves Adventure" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €95</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Gythio</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Diros Caves Adventure</h3>
            ...
            <Link href="/tours/kalamata/kalamata-mani-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/kalamata-mani-tour-hero-1.jpg" alt="Mani Peninsula Tour" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €85</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Kalamata</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Mani Peninsula Tour</h3>
                <p className="text-sm text-gray-600 mb-3">4 hours</p>
                <span className="text-blue-600 font-semibold text-sm">View Tour</span>
              </div>
            </Link>
            ...
            <Link href="/tours/athens/athens-city-tour/" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-48">
                <Image src="/images/athens-city-tour-hero-1.jpg" alt="Athens City & Acropolis" fill className="object-cover" />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded text-sm font-bold">From €320</div>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-600 mb-1">From Athens</p>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Athens City & Acropolis</h3>
                <p className="text-sm text-gray-600 mb-3">8 hours</p>
                <span className="text-blue-600 font-semibold text-sm">View Tour</span>
              </div>
            </Link>
          ...
          <div className="text-center">
            <Link href="/tours" className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded font-semibold transition-colors">
              View All Tours
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Link href="/trips/two-day-classic-trip" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-64">
                <Image src="/images/two-day-classic-hero-1.jpg" alt="2-Day Classic Tour in Nafplio" fill className="object-cover" />
                <div className="absolute top-4 right-4 bg-white px-4 py-2 rounded font-bold">From €380</div>
              </div>
              <div className="p-6">
                <p className="text-xs text-gray-600 mb-2">From Athens</p>
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">2-Day Classic Tour in Nafplio</h3>
                <p className="text-gray-700 mb-4">Explore ancient Mycenae, charming Nafplion, and the famous Epidavros Theater on this two-day adventure.</p>
                <p className="text-sm text-gray-600 mb-4">2 days • All Year</p>
                <span className="text-blue-600 font-semibold">View Full Itinerary</span>
              </div>
            </Link>
            ...
            <Link href="/trips/eight-day-greece-trip" className="group block bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <div className="relative h-64">
                <Image src="/images/eight-day-greece-hero-1.jpg" alt="8-Day Classical Greece Tour" fill className="object-cover" />
                <div className="absolute top-4 right-4 bg-white px-4 py-2 rounded font-bold">From €1,850</div>
              </div>
              <div className="p-6">
                <p className="text-xs text-gray-600 mb-2">From Athens</p>
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">8-Day Classical Greece Tour</h3>
                <p className="text-gray-700 mb-4">The ultimate journey through Classical Greece visiting Athens, Meteora, Delphi, Olympia, and Nafplion.</p>
          ...
          <div className="text-center">
            <Link href="/trips" className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded font-semibold transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/tours/nafplio/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-nafplio.jpg" alt="Nafplio" fill className="object-cover" />
            ...
            <Link href="/tours/athens/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-athens.jpg" alt="Athens" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <Link href="/tours/kalamata/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-kalamata.jpg" alt="Kalamata" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <Link href="/tours/gythio/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-gythio.jpg" alt="Gythio" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <Link href="/tours/portoheli/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-portoheli.jpg" alt="Porto Heli" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <Link href="/tours/poros/" className="group relative h-80 rounded-lg overflow-hidden shadow hover:shadow-xl transition-shadow">
              <Image src="/images/destination-poros.jpg" alt="Poros" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-700">Born and raised in Argos, we know the Peloponnese like no one else. Discover hidden gems that guidebooks never mention.</p>
            </div>

            <div className="text-center">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Licensed Guides</h3>
              <p className="text-gray-700">All our guides are licensed by the Greek Ministry of Culture, ensuring authentic and professional experiences.</p>
            </div>

            <div className="text-center">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Personalized Service</h3>
              <p className="text-gray-700">Every tour is tailored to your interests, pace, and preferences. We create memories, not just itineraries.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow">
              <p className="text-gray-700 mb-6 leading-relaxed">An absolutely incredible experience! Our guide's knowledge of ancient Greece brought history to life. The Mycenae tour was unforgettable.</p>
              <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              <p className="text-gray-700 mb-6 leading-relaxed">The food tour in Nafplio was the highlight of our trip. Authentic local cuisine, wonderful stories, and genuine Greek hospitality.</p>
              <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              <p className="text-gray-700 mb-6 leading-relaxed">Professional, knowledgeable, and truly passionate about sharing their culture. We felt like friends, not tourists. Highly recommend!</p>
              <div>
      ...
      <section className="relative py-24 px-4">
        <Image src="/images/monemvasia-tour-hero-1.jpg" alt="Plan your Greece trip" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50" />
        
        <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
          <h2 className="text-4xl font-bold mb-6">Ready to Explore Greece?</h2>
          <p className="text-xl mb-10">Let us design your perfect Peloponnese experience. Contact us today to start planning your unforgettable Greek adventure.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/plan-trip" className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded font-semibold transition-colors">Plan Your Trip</Link>
            <Link href="/contact" className="inline-block bg-white hover:bg-gray-100 text-gray-900 px-8 py-3 rounded font-semibold transition-colors">Contact Us</Link>
          </div>
        </div>
      </section>
    </div>
