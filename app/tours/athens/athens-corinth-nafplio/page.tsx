...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, Star, Waves, Landmark, Navigation, Shield, ArrowRight } from "lucide-react";
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Corinth Canal, Epidavros, Nafplio City & Mycenae</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Corinth Canal, Epidavros, Nafplio City & Mycenae from Athens" fill className="object-cover" priority />
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Corinth Canal</h3>
                      <p className="text-gray-600 leading-relaxed">Marvel at the huge engineering project that connects the Corinthian Gulf with the Saronic Gulf.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Epidaurus</h3>
                      <p className="text-gray-600 leading-relaxed">Visit one of the most famous archaeological monuments in Greece — the ancient theater, Temple of Asclepius, and the Tholos.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Nafplio Old Town</h3>
                      <p className="text-gray-600 leading-relaxed">Walk from the Land Gate through fairytale alleys, climb Akronafplia, and see the famous Bourtzi fortress.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Mycenae</h3>
                      <p className="text-gray-600 leading-relaxed">Explore the kingdom of mythical Agamemnon — the Lion Gate, Cyclopean walls, and vaulted tombs of Atreus and Clytemnestra.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/nafplio-city-tour-hero-1.jpg" alt="Nafplio and Mycenae" fill className="object-cover brightness-50" />
        </div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Experience Ancient Greece in One Day</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
            Book your tour to Corinth Canal, Epidavros, Nafplio and Mycenae.
          </p>
