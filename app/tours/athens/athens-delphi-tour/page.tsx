      ...
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Delphi Tour</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Journey to the ancient sanctuary of Delphi, considered by the Greeks to be the center of the world. 
                  This UNESCO World Heritage site was home to the famous Oracle of Apollo, where kings and commoners 
                  alike sought divine guidance for over a thousand years.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Travel through scenic central Greece, passing through charming mountain villages with spectacular 
                  views. Your licensed guide shares fascinating stories about ancient Greek mythology, history, and 
                  the powerful influence the Oracle wielded over the ancient world.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Explore the remarkable archaeological site perched on the slopes of Mount Parnassus. Walk the Sacred 
                  Way to the Temple of Apollo, where the Pythia delivered her cryptic prophecies. Visit the ancient 
                  theater with its breathtaking views, the Stadium where the Pythian Games were held, and the Tholos 
                  of Athena Pronaia, one of the most photographed ancient monuments in Greece.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Complete your visit at the exceptional Delphi Archaeological Museum, housing an outstanding collection 
                  of artifacts including the famous Charioteer statue and the Sphinx of Naxos. Your guide brings the 
                  ancient sanctuary to life, explaining its religious significance and political importance in shaping 
                  Greek civilization.
                </p>
              </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          <h2 className="font-display text-4xl md:text-5xl text-white mb-6 font-bold">
            Visit the Center of the Ancient World
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your Delphi tour and discover where gods spoke to mortals
          </p>
