...
const included = [
  ...
  "Meet a professional licensed guide to the archaeological sites upon request with an extra cost",
  "Liability",
  "Taxes",
];
...
export default function NafplioMycenaeEpidavros() {
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Mycenae - Epidavros</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Nafplio: Mycenae - Epidavros" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Nafplio: Mycenae - Epidavros</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-accent" /><span className="font-semibold">Pick-up:</span> 8:30 AM & 10:00 AM</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Discover two of the most important archaeological sites in Greece on this tour. After getting picked up in Nafplion, head to your first stop, Mycenae. Travel to the mythical Kingdom of Agamemnon and learn more about one of the most brilliant cultures in prehistoric Greece, the Mycenaean civilization. During the 2nd millennium BC, Mycenae was one of the largest Greek civilizations, with powerful military fortresses that dominated southern Greece.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Next head to the Lions Gate, the monumental palace entrance. See the Cyclopean walls around the Acropolis and the tombs of Atreus and Clytemnestra, a must for ancient history lovers.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Continuing on the tour, visit the famous archaeological site of Epidaurus, you will visit the Sanctuary dedicated to the god Apollo which was founded at around 800BC. Next, you will visit The Asclepieion of Epidaurus, dedicated to the gods with healing powers and the healing temple of serious diseases in ancient Greece. This site attracts a large number of pilgrims and patients.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Next, explore the ancient theatre, located within the archaeological site of the Sanctuary of Asklepios. Built at the end of the classical Era (330 BC) and famous for its elegance, perfect acoustics and unique design. It had a capacity of about 13,000 spectators. In 1988, the theater was incorporated, along with the entire Asclepius, into the Unesco World Heritage List.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Shield className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Mycenae</h3><p className="text-gray-600 leading-relaxed">Travel to the mythical Kingdom of Agamemnon — the Lions Gate, Cyclopean walls, and tombs of Atreus and Clytemnestra.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Epidaurus</h3><p className="text-gray-600 leading-relaxed">Visit the Sanctuary of Apollo (800 BC), the Asclepieion, and the ancient theatre (330 BC) with its perfect acoustics.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><BookOpen className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">UNESCO World Heritage</h3><p className="text-gray-600 leading-relaxed">The theatre was incorporated into the UNESCO World Heritage List in 1988 with a capacity of 13,000 spectators.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€160</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Pick-up:</span><span className="font-semibold text-gray-900">8:30 AM & 10:00 AM</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/mycenae-tour-hero-3.jpg" alt="Nafplio: Mycenae - Epidavros" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Discover Ancient Greece</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your tour to Mycenae and Epidavros from Nafplio.</p>
