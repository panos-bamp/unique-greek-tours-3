...
const highlights = [
  ...
  "Explore the mythical Kingdom of Agamemnon",
  "Walk through the famous Lion Gate",
  "See the ancient theatre of Epidavros with perfect acoustics",
  "Visit the Sanctuary of Asklepios",
      ...
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Mycenae & Epidavros Tour</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image
            ...
            alt="Mycenae and Epidavros tour gallery"
            fill
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <span className="font-semibold">Pick-up:</span> 8:30 AM & 10:00 AM
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2 border-b border-sand-100">
                      ...
                      <span className="font-semibold text-gray-900">8:30 AM & 10:00 AM</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-sand-100">
