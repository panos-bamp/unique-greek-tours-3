    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Ancient Olympia</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Nafplion: Ancient Olympia" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Nafplion: Ancient Olympia</h1>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">The grandeur of the ancient Greek culture unfolds in this corner of the Peloponnese, Ancient Olympia, the birthplace of the Olympic Games. Here you will have the chance to experience the honour, glory and wisdom of the ancient civilization that wooed the world.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">To start our tour we will transfer you in a private air-conditioned car to Olympia from Nafplion, for a day trip to one of the most important archaeological sites in Greece.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Here you will see the ancient stadium where the Olympic Games took place. The Sanctuary of Zeus, which housed one of the seven wonders of the ancient world, a 13.5-meter golden statue of the god, made by Phidias. The archaeological museum, with outstanding findings and you will see the amazing Hermes of Praxiteles.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Continuing on the tour in the surrounding area, you will see buildings and temples that depict the beauty, harmony and balance of ancient Greek art. Olympia is an inexhaustible source of culture and spirit, an experience that really deserves to live in Greece.</p>
                <p className="text-lg text-gray-700 leading-relaxed">At the end of the tour, we will have free time to enjoy a coffee or a meal at the nearby local cafes and restaurants.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Trophy className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Stadium</h3><p className="text-gray-600 leading-relaxed">See the stadium where the Olympic Games took place and the Sanctuary of Zeus with its 13.5-meter golden statue.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><BookOpen className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Archaeological Museum</h3><p className="text-gray-600 leading-relaxed">Outstanding findings including the amazing Hermes of Praxiteles.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Temples & Buildings</h3><p className="text-gray-600 leading-relaxed">Buildings and temples depicting the beauty, harmony and balance of ancient Greek art.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€290</div><div className="text-sm text-gray-600">per person</div></div>
