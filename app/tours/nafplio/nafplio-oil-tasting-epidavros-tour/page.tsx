...
const gallery = [
  "/images/oil-tasting-hero-1.jpg",
  "/images/oil-tasting-hero-2.jpg",
  "/images/oil-tasting-hero-3.jpg",
];
...
const included = [
  ...
  "Liability",
  "Taxes",
  "Entrance and Olive Oil tasting at the Olive Oil production plant",
];



export default function NafplioOilTastingEpidavros() {
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Epidavros & Olive Oil Tasting</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Ancient Epidavros & Olive Oil Tasting" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Ancient Epidavros & Olive Oil Tasting</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                <div className="flex items-center gap-2 text-gray-700"><Clock className="h-5 w-5 text-accent" /><span className="font-semibold">Duration:</span> 3.5 hours</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Our tour starts from Nafplion and we drive through the Argolic plane towards Epidaurus. Our first stop is an Olive Oil Production plant where we stroll around the premises, learning a lot about its story, the production process and do a tasting of Greek olive oil, olives and delicacies based on it.</p>
                <p className="text-lg text-gray-700 leading-relaxed">We continue the tour of ancient Epidaurus, where we explore the ancient theatre of one of the most famous archaeological monuments in Greece. We will also visit the Asclepieion of Epidaurus, which was the center of healing serious diseases for the whole of ancient Greece. Many monuments developed around it, most notably the temple of Asklepios, Tholos and others. The tour ends with our return to Nafplion.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Droplets className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Olive Oil Tasting</h3><p className="text-gray-600 leading-relaxed">Visit an Olive Oil Production plant — learn the story, production process, and taste Greek olive oil and delicacies.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Epidaurus</h3><p className="text-gray-600 leading-relaxed">Explore the ancient theatre and the Asclepieion, the center of healing in ancient Greece.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€115</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Duration:</span><span className="font-semibold text-gray-900">3.5 hours</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/oil-tasting-hero-3.jpg" alt="Ancient Epidavros & Olive Oil Tasting" fill className="object-cover brightness-50" /></div>
