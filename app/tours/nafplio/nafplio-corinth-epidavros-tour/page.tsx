    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Corinth & Epidavros Tour</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Nafplio: Mycenae - Anc. Corinth/Canal - Epidavros Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Nafplio: Mycenae - Anc. Corinth/Canal - Epidavros Tour</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                <div className="flex items-center gap-2 text-gray-700"><Clock className="h-5 w-5 text-accent" /><span className="font-semibold">Duration:</span> 8 hours</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">The Peloponnese was considered the centre of the ancient world. On this tour from Nafplio to Mycenae, you will have the opportunity to experience many important parts of it, as well as visit some of its most significant archeological sites and monuments.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Starting our trip from Nafplion, our first stop is a tour to Mycenae. We will travel to the mythical Kingdom of Agamemnon, where one of the most brilliant cultures of Greek prehistory, the Mycenaean civilization, developed. We will then head to the Lions Gate, the monumental entrance of the palaces. Next, we will see the Cyclopean walls around the Acropolis, and the tholos tombs of Atreus and Clytemnestra's, which are all must-see attractions for lovers of the ancient world.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Continuing on our tour, our next stop is Ancient Corinth, with the famous temple of Apollo and the steps of Apostle Paul and the Corinth Canal, which connects the Corinthian bay with the Saronic Gulf.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">We continue the tour of ancient Epidaurus, where we explore the ancient theatre of one of the most famous archaeological monuments in Greece. We will also visit the Asclepieion of Epidaurus, which was the centre of healing serious diseases for the whole of ancient Greece. Many monuments developed around it, most notably the temple of Asklepios, Tholos and others.</p>
                <p className="text-lg text-gray-700 leading-relaxed">The tour ends with our return to Nafplion.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Shield className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Mycenae</h3><p className="text-gray-600 leading-relaxed">The mythical Kingdom of Agamemnon — Lions Gate, Cyclopean walls, tholos tombs.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Corinth & Canal</h3><p className="text-gray-600 leading-relaxed">The famous temple of Apollo, steps of Apostle Paul, and the Corinth Canal.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><BookOpen className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Epidaurus</h3><p className="text-gray-600 leading-relaxed">The ancient theatre, the Asclepieion and temple of Asklepios.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€250</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Duration:</span><span className="font-semibold text-gray-900">8 hours</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/corinth-epidavros-tour-hero-3.jpg" alt="Nafplio: Mycenae - Anc. Corinth/Canal - Epidavros Tour" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">The Ultimate Ancient Greece Tour</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your tour to the greatest archaeological sites.</p>
