...
import { ArrowRight, Calendar, Check, ChevronLeft, ChevronRight, Clock, Landmark, MapPin, Mountain, Navigation, Star, Users } from "lucide-react";
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Monastery of Malevis</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Holy Monastery of Malevis Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Holy Monastery of Malevis Tour</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-accent" /><span className="font-semibold">Pick-up:</span> 9:00 AM - 11:00 AM</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">This tour gives you the opportunity to experience the majesty of your faith and come closer to your religion by visiting one of the most famous monasteries of Kynouria, the magnificent Holy Monastery of Panagia Malevis.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">We start your tour by picking you up from Nafplion and head towards Astros. We will end up in the idyllic, cedar-covered area of Agios Petros Kynourias, on the slopes of Parnon mountain, where the impressive Malevi Monastery is found. The name Malevi is associated with the highest peak of Parnon, (Malevo) where the monastery was originally built.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">This monastery was founded in 717 AD and here you will see the miraculous icon of the Assumption of the Virgin, the work of Evangelist Luke.</p>
                <p className="text-lg text-gray-700 leading-relaxed">If you wish, we are also able to have lunch in one of the surrounding villages that spring up through the firs. We can also visit the Loukou Monastery and the Monastery of Palaiopanagia, which are on our way. The tour ends with your return to our meeting point.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Malevi Monastery</h3><p className="text-gray-600 leading-relaxed">Visit the magnificent monastery founded in 717 AD with the miraculous icon by Evangelist Luke.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Mountain className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Parnon Mountain</h3><p className="text-gray-600 leading-relaxed">Journey to the idyllic cedar-covered slopes of Parnon mountain in Agios Petros Kynourias.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Navigation className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Additional Monasteries</h3><p className="text-gray-600 leading-relaxed">Option to visit Loukou Monastery and Palaiopanagia, and enjoy lunch in surrounding villages.</p></div></div>
                </div>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Pick-up:</span><span className="font-semibold text-gray-900">9:00 AM - 11:00 AM</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/malevi-tour-hero-3.jpg" alt="Holy Monastery of Malevis Tour" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Experience the Majesty of Faith</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your tour to the Holy Monastery of Malevis.</p>
