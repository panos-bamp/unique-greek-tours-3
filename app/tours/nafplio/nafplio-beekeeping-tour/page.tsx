...
import { ArrowRight, Calendar, Check, ChevronLeft, ChevronRight, Clock, Coffee, Eye, MapPin, Star, TreePine, Users } from "lucide-react";
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Beekeeping Tour</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Beekeeping Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Beekeeping Tour</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-accent" /><span className="font-semibold">Pick-up:</span> 9:00 AM & 12:00 PM</div>
                <div className="flex items-center gap-2 text-gray-700"><Users className="h-5 w-5 text-accent" /><span className="font-semibold">Trip Type:</span> For all (not recommended for children under 10 y.o.)</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Immerse yourself in the enchanting realm of bees with our unique Beekeeping Tour from Nafplion. Travel through the scenic orange groves of the Argolic plain to a modern beekeeping facility, where your adventure begins.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Explore the fascinating history of beekeeping at the on-site museum, and observe the intricate structure of a bee society through a glass hive. Don the special beekeeping attire and step into the fragrant bee gardens, where you'll learn firsthand how bees are nurtured and honey is harvested.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Conclude your experience with an educational tasting session, savoring a variety of organic honeys and other bee products. This interactive tour is perfect for those seeking a blend of taste and knowledge, offering a memorable journey into the sweet world of beekeeping.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Eye className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Beekeeping Museum</h3><p className="text-gray-600 leading-relaxed">Explore the history of beekeeping and observe bee society through a glass hive.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><TreePine className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Bee Gardens</h3><p className="text-gray-600 leading-relaxed">Don special attire and learn firsthand how bees are nurtured and honey is harvested.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Coffee className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Honey Tasting</h3><p className="text-gray-600 leading-relaxed">Savor a variety of organic honeys and other bee products in an educational tasting session.</p></div></div>
                </div>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Pick-up:</span><span className="font-semibold text-gray-900">9:00 AM & 12:00 PM</span></div>
                    ...
                    <div className="flex justify-between py-2"><span className="text-gray-600">Tour Type:</span><span className="font-semibold text-gray-900">For all (not recommended for children under 10 y.o.)</span></div>
                  </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/beekeeping-tour-hero-3.jpg" alt="Beekeeping Tour" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Discover the World of Bees</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your beekeeping tour from Nafplion.</p>
