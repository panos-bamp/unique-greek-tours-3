...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, X, Utensils, Camera, Landmark, Wine, ArrowRight } from "lucide-react";
...
const highlights = [
  "Combine culture and culinary experiences",
  "Visit archaeological sites",
  "Taste local specialties and wines",
  "Expert tour leader guidance",
  "Discover Greek food traditions",
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Culture & Taste Tour</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Experience the perfect blend of culture and cuisine on this comprehensive tour that combines ancient 
                  history with authentic Greek flavors. This unique experience offers the best of both worlds - exploring 
                  archaeological treasures and savoring local gastronomy.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Begin with visits to significant archaeological sites in the region, learning about ancient Greek 
                  civilization from your knowledgeable tour leader. Discover the stories behind the ruins and understand 
                  how ancient Greeks lived, worshipped, and celebrated.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Transition from ancient history to culinary traditions as you visit local producers and food artisans. 
                  Taste regional specialties, traditional cheeses, premium olive oil, and local wines. Learn how Greek 
                  food culture has evolved from ancient times to today.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  This tour provides a deeper understanding of Greek culture by connecting historical knowledge with 
                  living traditions. Perfect for those who want a comprehensive cultural experience that engages all 
                  the senses.
                </p>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200">
                    ...
                    <div className="text-sm text-gray-600 mt-1">€80 per child</div>
                  </div>
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          ...
          alt="Book your culture and taste tour"
          fill
          className="object-cover brightness-40"
        />
        <div className="container-custom relative z-10 text-center">
          <h2 className="font-display text-4xl md:text-5xl text-white mb-6 font-bold">
            Experience Greece Through History & Flavor
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your culture & taste tour and discover the perfect blend of ancient heritage and culinary traditions
          </p>
