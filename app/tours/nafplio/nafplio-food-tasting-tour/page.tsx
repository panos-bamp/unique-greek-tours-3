...
const gallery = [
  "/images/food-tasting-hero-1.jpg",
  "/images/food-tasting-hero-2.jpg",
  "/images/food-tasting-hero-3.jpg",
];

const included = [
  "English guided tour of Nafplion",
  "Pick up from your hotel or our meeting point",
  "Entrance and food samples",
  "Liability",
  "Taxes",
];
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Food Tasting Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Food Tasting Tour</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                <div className="flex items-center gap-2 text-gray-700"><Clock className="h-5 w-5 text-accent" /><span className="font-semibold">Duration:</span> 3 - 3.5 hours</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Discover the rich culinary heritage of Nafplion with an unforgettable food-tasting journey led by a knowledgeable local guide. Stroll through the city's most iconic landmarks, stopping to indulge in handpicked flavors from carefully selected artisan shops.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Begin with a perfectly brewed Greek coffee, then savor an array of traditional cheeses, cold meats, olives, olive oil, and sweet treats with yogurt at a charming grocery store. Wander through Nafplion's picturesque central square, surrounded by Venetian neoclassical gems, before arriving at an elegant cellar.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Here, a wine sommelier will introduce you to the world of Greek wines, ouzo, and tsipouro, tracing their roots back to ancient times. Conclude this sensory experience at Nafplion's scenic port, soaking in the view of the historic Bourtzi castle, as the aromas and tastes of this culinary adventure linger.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Store className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Artisan Shops</h3><p className="text-gray-600 leading-relaxed">Taste traditional cheeses, cold meats, olives, olive oil, and sweet treats at carefully selected shops.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Wine className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Wine Cellar</h3><p className="text-gray-600 leading-relaxed">A sommelier introduces you to Greek wines, ouzo, and tsipouro tracing roots to ancient times.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Eye className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Nafplion Landmarks</h3><p className="text-gray-600 leading-relaxed">Stroll through the picturesque central square and conclude at the scenic port with Bourtzi castle views.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€100</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Duration:</span><span className="font-semibold text-gray-900">3 - 3.5 hours</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/food-tasting-hero-3.jpg" alt="Food Tasting Tour" fill className="object-cover brightness-50" /></div>
