...
import { ArrowRight, Calendar, Check, ChevronLeft, ChevronRight, Clock, Coffee, Eye, Landmark, MapPin, Star, Users } from "lucide-react";
...
const included = [
  ...
  "Liability",
  "Taxes",
  "Ticket at the archaeological sites",
];
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Argos Cultural Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Argos Cultural Tour</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                <div className="flex items-center gap-2 text-gray-700"><Clock className="h-5 w-5 text-accent" /><span className="font-semibold">Duration:</span> 5 hours</div>
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-accent" /><span className="font-semibold">Pick-up:</span> 9:00 AM & 2:00 PM</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Discover the timeless allure of Argos, the oldest city in continental Europe and a pivotal center of Mycenaean civilization. This captivating tour from Nafplion takes you on a journey through millennia, starting at the Lerna Archaeological Site, where myths and ancient ruins intertwine. Marvel at the enigmatic Pyramid of Elliniko, a testament to ancient architectural prowess, and visit the serene Zoodochos Pigi church, nestled in the tranquil village of Kefalari.</p>
                <p className="text-lg text-gray-700 leading-relaxed">In Argos, explore the majestic ancient theater, a marvel of classical design, and stroll through the remnants of the ancient market and Byzantine Museum, delving into the rich tapestry of Greek history. Conclude your cultural immersion with a relaxing coffee or meal in the picturesque St. Peter's Square, before returning to Nafplion. Enjoy a luxurious and safe transfer, making this historical adventure both enriching and comfortable.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Lerna & Pyramid of Elliniko</h3><p className="text-gray-600 leading-relaxed">Visit the Lerna Archaeological Site and marvel at the enigmatic Pyramid of Elliniko.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Eye className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Theater & Byzantine Museum</h3><p className="text-gray-600 leading-relaxed">Explore the majestic ancient theater and the remnants of the ancient market and Byzantine Museum.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Coffee className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">St. Peter's Square</h3><p className="text-gray-600 leading-relaxed">Conclude with a relaxing coffee or meal in the picturesque square before returning to Nafplion.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€190</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Duration:</span><span className="font-semibold text-gray-900">5 hours</span></div>
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Pick-up:</span><span className="font-semibold text-gray-900">9:00 AM & 2:00 PM</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/argos-tour-hero-3.jpg" alt="Argos Cultural Tour" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Explore the Oldest City in Europe</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your Argos cultural tour from Nafplion.</p>
