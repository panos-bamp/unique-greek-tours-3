  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/nafplio-hiking-karathona-tour-hero-3.jpg" alt="Hiking to Karathona Beach - Agios Nikolaos" fill className="object-cover brightness-50" /></div>
