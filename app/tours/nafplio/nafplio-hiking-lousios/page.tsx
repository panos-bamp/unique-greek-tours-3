...
const gallery = [
  "/images/hiking-lousios-hero-1.jpg",
  "/images/hiking-lousios-hero-2.jpg",
  "/images/hiking-lousios-hero-3.jpg",
];
...
export default function NafplioHikingLousios() {
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Hiking Lousios Gorge - Dimitsana - Anc. Gortyna" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Hiking Lousios Gorge - Dimitsana - Anc. Gortyna</h1>
              <div className="flex flex-wrap gap-6 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-700"><Users className="h-5 w-5 text-accent" /><span className="font-semibold">Trip Type:</span> Small groups, relatively good fitness required (not suggested for children)</div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">A very interesting hike along one of the wildest gorges and rivers of our country, in an environment of wild and orgiastic nature.</p>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Hikers have the opportunity to visit two medieval (Byzantine) monasteries hanging on the vertical rocks, where the inhabitants sought isolation and protection in adventurous times. The monastery of Philosophos (founded in 963) and the monastery of Prodromos (founded in 1167). They will also visit the Asclepius (ancient healing center), dedicated to the god of medicine Asclepius, part of the ancient city of Gortyna at the end of the gorge. At this location we can enjoy a refreshing swim in the crystal clear waters of the Lousios River.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Continuing the hike, the group will approach ancient Gortyna, where our route ends.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Mountain className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Lousios Gorge</h3><p className="text-gray-600 leading-relaxed">Hike along one of the wildest gorges in Greece, starting from picturesque Dimitsana. Distance: 12 km, Medium difficulty.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Byzantine Monasteries</h3><p className="text-gray-600 leading-relaxed">Visit the monastery of Philosophos (963 AD) and Prodromos (1167 AD) hanging on vertical rocks.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Waves className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Gortyna</h3><p className="text-gray-600 leading-relaxed">Visit the Asclepius healing center and enjoy a refreshing swim in the crystal clear Lousios River.</p></div></div>
                </div>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2"><span className="text-gray-600">Tour Type:</span><span className="font-semibold text-gray-900">Small groups, relatively good fitness required (not suggested for children)</span></div>
                  </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/hiking-lousios-hero-3.jpg" alt="Hiking Lousios Gorge - Dimitsana - Anc. Gortyna" fill className="object-cover brightness-50" /></div>
