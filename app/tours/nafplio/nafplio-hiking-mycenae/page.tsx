...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, X, Mountain, Landmark, Camera, ArrowRight } from "lucide-react";
...
const highlights = [
  "Hike ancient paths to Mycenae",
  "Visit Prosymna archaeological site",
  "Panoramic views of Argolic plain",
...
export default function NafplioMycenaeHikingTour() {
    ...
    <div className="flex flex-col">
      <div className="bg-sand-50 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-primary">Mycenae Hiking</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Walk in the footsteps of ancient heroes on this archaeological hiking adventure from Mycenae to 
                  Prosymna. Combine the thrill of mountain hiking with the wonder of discovering one of Greece's 
                  most significant Bronze Age civilizations in their dramatic natural setting.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Begin near the legendary citadel of Mycenae, home of King Agamemnon and the Mycenaean civilization 
                  that dominated Greece 3,500 years ago. Your professional guide leads you along ancient pathways that 
                  connect Mycenae to the lesser-known but equally fascinating site of Prosymna.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  The trail offers spectacular views across the Argolic plain, where myths and history intertwine. 
                  Learn about Mycenaean culture, the Trojan War legends, and Heinrich Schliemann's dramatic discoveries. 
                  Explore the Prosymna sanctuary site with its ancient fortifications and cult buildings, rarely visited 
                  by tourists.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  The landscape reveals layers of history - from Neolithic settlements to Mycenaean palaces, Classical 
                  Greek sanctuaries to Byzantine chapels. Your guide brings these ruins to life with stories of gods, 
                  heroes, and the people who shaped Western civilization. This unique tour offers an intimate encounter 
                  with archaeological sites away from the crowds.
                </p>
              </div>
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          ...
          alt="Book your Mycenae hiking tour"
          fill
          className="object-cover brightness-40"
        />
        <div className="container-custom relative z-10 text-center">
          <h2 className="font-display text-4xl md:text-5xl text-white mb-6 font-bold">
            Walk Among Ancient Legends
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your Mycenae hiking tour and discover hidden archaeological treasures
          </p>
