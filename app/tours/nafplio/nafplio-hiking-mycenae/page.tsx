...
const gallery = [
  "/images/hiking-mycenae-hero-1.jpg",
  "/images/hiking-mycenae-hero-2.jpg",
  "/images/hiking-mycenae-hero-3.jpg",
];
...
export default function NafplioHikingMycenae() {
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Hiking Mycenae - Prosymna" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Hiking Mycenae - Prosymna</h1>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">The hike starts from ancient Mycenae, the capital of the Mycenaean civilization of the Bronze Age, and through crops and olive groves, ends at the village of Prosymni, offering stunning views of the acropolis and the ancient city.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Along the way, we will have the opportunity to see a series of ancient ruins, such as a Hellenistic tower, Roman baths, a watermill and a stone bridge from the Xalcos era.</p>
                <p className="text-lg text-gray-700 leading-relaxed">The path we will follow was part of a road network that connected Corinth with Argos in antiquity.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Mountain className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Mycenae to Prosymni</h3><p className="text-gray-600 leading-relaxed">Hike through crops and olive groves with stunning views of the acropolis. Distance: 5.5 km, Easy difficulty.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Ruins</h3><p className="text-gray-600 leading-relaxed">See a Hellenistic tower, Roman baths, a watermill and a stone bridge from the Xalcos era.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Navigation className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Ancient Road Network</h3><p className="text-gray-600 leading-relaxed">Follow a path that connected Corinth with Argos in antiquity.</p></div></div>
                </div>
              </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/hiking-mycenae-hero-3.jpg" alt="Hiking Mycenae - Prosymna" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Hike Through Ancient History</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your hiking tour from Mycenae to Prosymna.</p>
