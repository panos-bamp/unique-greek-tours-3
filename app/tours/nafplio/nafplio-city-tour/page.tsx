...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, Star, Navigation, Landmark, Wine, Eye, ArrowRight } from "lucide-react";
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Nafplio City Tour" fill className="object-cover" priority />
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">Nafplio City Tour</h1>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Discover Nafplio the romantic city of Argolis on a 3-hour walking tour, ideal for those visiting the city for the first time. Start your adventure in the Venetian city by meeting your tour leader at your hotel. Walkthrough the Land Gate, the only entrance to the city during the Venetian occupation, then walk to Psaromahalas, the only street inhabited by Greeks during the Turkish occupation and admire the views of the old town with its warm, earthy colours and ornate doors. You will also, pass by the point where Ioannis Kapodistrias, the first ruler of Greece, was assassinated.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">As you tour the town's beautiful and picturesque alleyways, you will head in the direction to Anafiotika, where you will then walk uphill to the Acropolis of Nafplion and marvel at the unique panoramic views of the bay.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">After seeing Anafiotika and on the way back to main town, you will stop at the beginning of the port of the city and see crenels and cannons that were there to protect the city from invaders. The spot is idyllic, with the natural rockpools stretching beneath the cannons and the argillic gulf.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">Your tour leader will share stories of the charming city of Nafplio and its long history while walking through Syntagma Square, where the Venetian and neoclassical buildings such as the parliament and the Archaeological Museum dominate your surroundings. Also see the main street full of colorful shops and the Three Admirals' Square with the classic Town Hall building.</p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">You will also experience the culture of Nafplion by tasting local products such as Tsipouro and wines from Nemea. These tastes will complement the history of Nafplion and complete a perfect tour.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Then the tour ends, at the port of the city, where you'll learn about the Bourtzi castle, a Venetian fortress built on a nearby island, which stands as the most recognized attraction of Nafplion.</p>
              </div>
              <div className="mb-12">
                <h2 className="font-display text-3xl text-primary mb-6">What You Can Expect</h2>
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Navigation className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Old Town Walking Tour</h3><p className="text-gray-600 leading-relaxed">Walk through the Land Gate, Psaromahalas, picturesque alleyways, Anafiotika, and up to the Acropolis of Nafplion for panoramic views.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Landmark className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Historical Landmarks</h3><p className="text-gray-600 leading-relaxed">Syntagma Square with Venetian and neoclassical buildings, the parliament, Archaeological Museum, Three Admirals' Square, and the Bourtzi castle.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Wine className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Local Tastings</h3><p className="text-gray-600 leading-relaxed">Taste local products such as Tsipouro and wines from Nemea to complement the history of Nafplion.</p></div></div>
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center text-accent"><Eye className="h-6 w-6" /></div></div><div className="flex-1"><h3 className="font-display text-xl font-bold text-primary-dark mb-2">Venetian Fortifications</h3><p className="text-gray-600 leading-relaxed">See crenels and cannons at the port, natural rockpools, and learn about the city's defense against invaders.</p></div></div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200"><div className="text-sm text-gray-600 mb-2">From</div><div className="font-display text-4xl font-bold text-primary-dark">€80</div><div className="text-sm text-gray-600">per person</div></div>
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2 border-b border-sand-100"><span className="text-gray-600">Pick-up:</span><span className="font-semibold text-gray-900">10am & 6pm</span></div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"><Image src="/images/nafplio-city-tour-hero-3.jpg" alt="Nafplio" fill className="object-cover brightness-50" /></div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Discover the Romance of Nafplio</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">Book your city tour and experience the history and tastes of Greece's first capital.</p>
