          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl md:text-5xl text-primary mb-6 font-bold">
                Porto Heli Private Sailing Tours
              </h1>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Experience the ultimate luxury of private sailing in the crystal-clear waters around Porto Heli. 
                  Explore hidden coves, secluded beaches, and pristine islands at your own pace aboard a beautiful 
                  sailboat with your own professional English-speaking skipper.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Your private charter can be customized to your preferences - whether you want to visit the famous 
                  island of Spetses, discover remote beaches accessible only by sea, or simply relax and enjoy the 
                  Mediterranean sun while sailing through the stunning Argolic Gulf.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Stop at turquoise bays for swimming and snorkeling in pristine waters. All equipment is provided, 
                  along with refreshing snacks and drinks. Your experienced skipper knows the best spots and can 
                  adjust the itinerary based on weather conditions and your interests.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Whether you choose a half-day excursion or a full-day adventure, sailing offers an unforgettable 
                  way to experience the Greek islands. Feel the wind in your hair, enjoy the gentle rocking of the 
                  waves, and create memories that will last a lifetime on this exclusive maritime journey.
                </p>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200">
                    ...
                    <div className="text-sm text-gray-600 mt-2">Custom quotes based on duration and group size</div>
                  </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your private sailing tour and discover the Greek islands in luxury and style
          </p>
