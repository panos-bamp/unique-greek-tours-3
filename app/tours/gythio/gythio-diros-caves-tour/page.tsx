                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Enjoy a beautiful drive through the mountainous scenery and picturesque villages of the Mani Peninsula.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Learn about fossilized animal bones and ceramics found in the caves, indicating prehistoric human habitation.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Optional Seaside Lunch</h3>
                      <p className="text-gray-600 leading-relaxed">Stop at beautiful Limeni fishing village for local dishes next to turquoise waters (optional).</p>
                    </div>
                  </div>
                </div>
              </div>
