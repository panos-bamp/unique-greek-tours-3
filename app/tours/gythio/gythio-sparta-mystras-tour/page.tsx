...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, X, Castle, Church, Landmark, Camera, ArrowRight } from "lucide-react";
...
const highlights = [
  "Ancient Sparta archaeological site",
  "Byzantine Mystras fortress-city",
  "UNESCO World Heritage site",
  "Stunning mountain views",
  "Medieval churches with frescoes",
  "Rich Spartan and Byzantine history",
];
  ...
  return (
    <div className="flex flex-col">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Journey through millennia of Greek history on this fascinating tour combining ancient Sparta, legendary 
                  warrior capital of the classical world, with medieval Mystras, a remarkably preserved Byzantine fortress 
                  city perched on Mount Taygetos. Experience two distinct yet equally compelling eras of Greek civilization.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Begin in Sparta, exploring archaeological remains of the city-state that produced history's most formidable 
                  warriors. Visit the sanctuary of Artemis Orthia where Spartan boys underwent brutal training rituals, 
                  the ancient theater, and the Acropolis. Learn about Spartan society, the famous agoge education system, 
                  and the legendary Battle of Thermopylae.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Continue to Mystras, a UNESCO World Heritage site that served as the Byzantine Empire's last stronghold 
                  before the Ottoman conquest. Wander through this ghost city's cobbled streets, exploring magnificent 
                  churches adorned with exceptional 14th and 15th-century frescoes. Visit the Palace of Despots, monasteries, 
                  and defensive walls that cascade down the hillside.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Climb to the fortress at the summit for breathtaking panoramic views across the Evrotas Valley. Mystras 
                  was a major center of Byzantine culture and learning, where scholars helped preserve ancient Greek 
                  knowledge through the medieval period. This tour offers an extraordinary journey from Sparta's military 
                  glory to Byzantium's artistic and spiritual achievements.
                </p>
              </div>
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          src="/images/mystras-tour-hero-3.jpg"
          alt="Book your Sparta and Mystras tour"
          fill
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your Sparta & Mystras tour and journey through epic Greek history
          </p>
