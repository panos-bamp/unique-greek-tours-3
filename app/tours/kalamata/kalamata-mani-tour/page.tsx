...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, Star, Eye, Anchor, Navigation, ArrowRight } from "lucide-react";
...
const included = [
  "Return transportation from Kalamata to Mani villages",
    ...
    <div className="flex flex-col">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Enjoy a tour through the coastal villages of Mani! You'll first stop at the "balcony of 
                  Kardamyli" and admire the views on the island of Meropi. Then, you'll continue towards the 
                  natural port of Agios Nikolaos.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Afterwards, you'll go back to Kardamyli, the home of the British writer Sir Patrick Leigh 
                  Fermor, and have some free time to explore the village.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Admire spectacular views on the island of Meropi from this famous panoramic viewpoint.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Visit the charming natural harbor along the dramatic Mani coastline.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Explore the historic village, home of British writer Sir Patrick Leigh Fermor, with free time to wander.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/kalamata-mani-tour-hero-3.jpg" alt="Villages of Mani" fill className="object-cover brightness-50" />
        </div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Discover the Coastal Mani</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
            Book your Mani villages tour and explore where mountains meet the sea.
          </p>
