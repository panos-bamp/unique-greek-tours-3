...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, Star, Landmark, Trophy, BookOpen, TreePine, ArrowRight } from "lucide-react";
...
const included = [
  "Return private transportation from Kalamata to Olympia",
  "Liability",
  "Taxes",
];
...
const excluded = [
  ...
  "Guided tour by an English-speaking licensed guide",
  "Personal expenses",
];

export default function KalamataOlympiaTour() {
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Ancient Olympia Tour from Kalamata" fill className="object-cover" priority />
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Since you are staying in the western Peloponnese, the beautiful area of Kalamata, you have the 
                  unique chance to visit one of the most celebrated monuments of ancient Greece, Olympia. You will 
                  be picked up from your hotel in Kalamata and driving through the beautiful valley of Alpheios 
                  river, you will reach the unique land of Ancient Olympia. Olympia was the most important religious 
                  and athletic center in Greece.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  In this fascinating tour, escorted by your professional licensed guide, you will visit the stadium, 
                  where the Olympic Games were held. Also the Temple of Zeus, with the 13.5 meters high golden statue 
                  of the god, one of the seven wonders of ancient world. The outstanding findings exhibited in the 
                  archaeological museum of Olympia, will amaze you, starting with the exquisite Hermes of Praxiteles. 
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Before your return to Kalamata you will have time to enjoy a break or a meal at the nearby caffes 
                  and restaurants.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Olympia is an inexhaustible source of culture and spirit, an experience that really deserves to 
                  live in Greece!
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">The Ancient Stadium</h3>
                      <p className="text-gray-600 leading-relaxed">Visit the stadium where the Olympic Games were held, the birthplace of athletic competition.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">See the temple that housed the 13.5 meters high golden statue of Zeus, one of the seven wonders of the ancient world.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Marvel at outstanding findings including the exquisite Hermes of Praxiteles sculpture.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Alpheios Valley Drive</h3>
                      <p className="text-gray-600 leading-relaxed">Scenic drive through the beautiful valley of Alpheios river to reach Ancient Olympia.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl border border-sand-200 p-8">
                  <div className="text-center mb-6 pb-6 border-b border-sand-200">
                    ...
                    <div className="font-display text-4xl font-bold text-primary-dark">€300</div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/olympia-tour-hero-3.jpg" alt="Ancient Olympia" fill className="object-cover brightness-50" />
        </div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Where Champions Were Born</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
            Book your Ancient Olympia tour and walk where legends competed.
          </p>
