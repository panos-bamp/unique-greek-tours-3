...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, X, Flame, Landmark, Trophy, Camera, ArrowRight } from "lucide-react";
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Visit the birthplace of the Olympic Games on this inspiring full-day tour from Kalamata. Ancient 
                  Olympia was the most important sanctuary dedicated to Zeus and hosted the original Olympic Games for 
                  over a millennium, uniting the Greek world in peaceful athletic competition.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Explore the extensive archaeological site set in a beautiful valley of plane trees and pines. Walk 
                  through the ruins of the magnificent Temple of Zeus, which once housed one of the Seven Wonders of 
                  the Ancient World - the gold and ivory statue of Zeus created by the sculptor Pheidias.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Stand in the ancient stadium where athletes competed for glory and olive wreaths. Run along the same 
                  track where champions raced 2,800 years ago, feeling the spirit of athletic excellence that inspired 
                  the modern Olympic movement. Visit the Temple of Hera, where the Olympic flame is still lit for today's 
                  games.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Complete your visit at the exceptional Archaeological Museum, housing an outstanding collection including 
                  the famous Hermes of Praxiteles sculpture and the elaborate pediment sculptures from the Temple of Zeus. 
                  This UNESCO World Heritage site offers an unforgettable journey into the ancient world where sport, 
                  religion, and culture converged in spectacular harmony.
                </p>
              </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Request your Ancient Olympia tour and walk where legends competed
          </p>
