...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, Star, Church, Landmark, TreePine, Mountain, Waves, ArrowRight } from "lucide-react";
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="relative h-[70vh]">
          <Image src={gallery[currentImage]} alt="Mountain E-bike Tour" fill className="object-cover" priority />
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">The Monastery</h3>
                      <p className="text-gray-600 leading-relaxed">First stop after touring Sfairia and the port of Poros, a peaceful scenic spot.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">About 2km uphill — the most challenging part of the route, rewarded with incredible views at the ancient temple.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">Rest under the coolness of the plane trees after an easy downhill section from the temple.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Off-Road to Russian Naval Station</h3>
                      <p className="text-gray-600 leading-relaxed">Off-road adventure from Vrysoula towards the Russian Naval Station, enjoying the view of Poros from above.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-display text-xl font-bold text-primary-dark mb-2">Beach Break</h3>
                      <p className="text-gray-600 leading-relaxed">A break at a beautiful beach for snorkeling and relaxation near by the sea during the tour.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/bike-tour-hero-3.jpg" alt="E-bike Tour Poros" fill className="object-cover brightness-50" />
        </div>
        <div className="container-custom relative z-10 text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl mb-6 font-bold">Explore Poros the Modern Way</h2>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
            Book your e-bike tour and discover hidden mountain trails with ease.
          </p>
