...
import { ChevronLeft, ChevronRight, Clock, Users, Calendar, MapPin, Check, X, Star, Compass, Mountain, Camera, ArrowRight } from "lucide-react";
...
const highlights = [
  "Stone-built Dana Lighthouse (1870)",
  "Gerolimano and Russian Naval Base beaches",
  "Swimming stop along the coast",
  "Optional lunch at Vasilis Tavern",
  "Saronic Gulf and Methana views",
  "Monument of modern maritime history",
];
