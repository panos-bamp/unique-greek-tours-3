            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Embark on a memorable sea kayaking adventure to the enchanting Eros Island, a small uninhabited 
                  paradise just off the coast of Poros. Paddle through the calm, turquoise waters of the Saronic 
                  Gulf and discover hidden coves, secluded beaches, and pristine natural beauty.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Your professional kayak instructor provides all equipment and safety briefing, making this adventure 
                  suitable for beginners and experienced paddlers alike. Learn basic kayaking techniques as you glide 
                  along the scenic coastline, enjoying spectacular views of Poros and the surrounding islands.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Reach Eros Island and explore its rocky shores and hidden beaches accessible only by sea. Snorkel 
                  in crystal-clear waters teeming with marine life, discovering colorful fish and fascinating underwater 
                  rock formations. The sheltered coves offer perfect spots for swimming and relaxation.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  This eco-friendly adventure allows you to experience the Saronic Gulf's natural wonders while getting 
                  a great workout. The relatively short distance makes it ideal for those new to sea kayaking, while 
                  the stunning scenery and peaceful surroundings create an unforgettable island-hopping experience.
                </p>
              </div>
